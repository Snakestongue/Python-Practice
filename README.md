...
Uses students.csv within that folder as well
...
Uses studentPerformance.csv within that folder as well
...
[View Project](Basics+/BigProjects/calc.py)

### Basic Notes App
A basic project that saves content to a .txt file.

[View Project](FildHandle/notesApp/notes.py)
Uses main.py & notes.txt within the same folder as well 
